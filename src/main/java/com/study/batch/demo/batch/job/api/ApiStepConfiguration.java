package com.study.batch.demo.batch.job.api;

import com.study.batch.demo.batch.chunk.processor.ApiItemProcessor1;
import com.study.batch.demo.batch.chunk.processor.ApiItemProcessor2;
import com.study.batch.demo.batch.chunk.processor.ApiItemProcessor3;
import com.study.batch.demo.batch.chunk.writer.ApiItemWriter1;
import com.study.batch.demo.batch.chunk.writer.ApiItemWriter2;
import com.study.batch.demo.batch.chunk.writer.ApiItemWriter3;
import com.study.batch.demo.batch.classifier.ProcessorClassifier;
import com.study.batch.demo.batch.classifier.WriterClassifier;
import com.study.batch.demo.batch.domain.ApiRequestVO;
import com.study.batch.demo.batch.domain.ProductVO;
import com.study.batch.demo.batch.partition.ProductPartitioner;
import com.study.batch.demo.batch.service.ApiService1;
import com.study.batch.demo.batch.service.ApiService2;
import com.study.batch.demo.batch.service.ApiService3;
