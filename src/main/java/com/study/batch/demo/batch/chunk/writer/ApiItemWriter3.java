package com.study.batch.demo.batch.chunk.writer;

import com.study.batch.demo.batch.domain.ApiRequestVO;
import com.study.batch.demo.batch.domain.ApiResponseVO;
import com.study.batch.demo.batch.service.AbstractApiService;
...
public class ApiItemWriter3 extends FlatFileItemWriter<ApiRequestVO> {
    ...
    public void write(List<? extends ApiRequestVO> items) throws Exception {
        ...
        super.setResource(new FileSystemResource("/Users/charlie/IdeaProjects/demo/src/main/resources/product3.txt"));
